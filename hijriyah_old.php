...
//	echo "DV Deg = " . $DV_deg;	
	...
	$txtDegree=$degree . "° " . $minute . "' " . floor($second) . '"';
	...
	// End If
	$tglHijriyahX=$secValue/(24*3600);
	$firstSecond=$secValue - floor($tglHijriyahX) * 24 * 3600;
	$pndpt=10;  //Konjungsi jam 14:00
	$reqDegree=2;

	if ($firstSecond>$pndpt*3600) { //konjungsi sebelum jam 14:00
		$tglHijriyah=floor($tglHijriyahX) +1;
	...
	$bulanHijriyah=array("Jumadil Awal","Jumadil Akhir","Rajab","Sya'ban","Ramadhan","Syawal","Zulqa'dah","Zulhijjah","Muharam","Shafar","Robiul Awal","Robiul Akhir");
